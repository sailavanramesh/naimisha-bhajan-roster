...
export const DEITY_SYMBOLS: Record<string, Emblem> = {
  ...
  Ganesha: {
    ...
    node: (
      <g>
        ...
        />
        {/* ears */}
        <path d="M6.7 7.4c-1.7-.3-2.9.7-2.9 2.3 0 1.7 1.3 2.9 3 2.7" fill={AMBER} fillOpacity="0.5" stroke={BROWN} strokeWidth="1.3" />
        <path d="M17.3 7.4c1.7-.3 2.9.7 2.9 2.3 0 1.7-1.3 2.9-3 2.7" fill={AMBER} fillOpacity="0.5" stroke={BROWN} strokeWidth="1.3" />
        {/* trunk */}
  ...
  Krishna: {
    ...
    node: (
      <g>
        ...
        <ellipse cx="13.4" cy="8" rx="5" ry="6.4" fill={TEAL} fillOpacity="0.35" stroke={TEAL} strokeWidth="1.3" />
  ...
  Devi: {
    ...
    node: (
      <g stroke={PLUM} strokeWidth="1.3" strokeLinejoin="round">
        <path d="M12 4.2c1.9 2.7 1.9 6 0 8.6-1.9-2.6-1.9-5.9 0-8.6Z" fill={PLUM} fillOpacity="0.3" />
        <path d="M12 12.8c2.5-2.2 5.3-2.6 7.6-1-1.4 2.8-4.2 4.3-7.6 3.6Z" fill={PLUM} fillOpacity="0.22" />
        <path d="M12 12.8c-2.5-2.2-5.3-2.6-7.6-1 1.4 2.8 4.2 4.3 7.6 3.6Z" fill={PLUM} fillOpacity="0.22" />
  ...
  Narayana: {
    ...
    node: (
      <g stroke={PEACOCK} strokeWidth="1.4">
        <circle cx="12" cy="12" r="8.2" fill={PEACOCK} fillOpacity="0.16" />
  ...
  Guru: {
    ...
    node: (
      <g stroke={BROWN} strokeWidth="1.3">
        <path d="M6.4 5.4c1.8 0 2.7 1.3 2.7 3.9 0 3.2-.9 6.2-2.7 6.2s-2.7-3-2.7-6.2c0-2.6.9-3.9 2.7-3.9Z" fill={BROWN} fillOpacity="0.2" />
        <path d="M17.6 8.5c1.8 0 2.7 1.3 2.7 3.9 0 3.2-.9 6.2-2.7 6.2s-2.7-3-2.7-6.2c0-2.6.9-3.9 2.7-3.9Z" fill={BROWN} fillOpacity="0.2" />
  ...
  Anjaneya: {
    ...
    node: (
      <g>
        ...
        <circle cx="16.4" cy="7.6" r="4.2" fill={GOLD} fillOpacity="0.4" stroke={GOLD} strokeWidth="1.4" />
  ...
  Surya: {
    ...
    node: (
      <g stroke={AMBER} strokeWidth="1.5" strokeLinecap="round">
        <circle cx="12" cy="12" r="4.4" fill={AMBER} fillOpacity="0.4" />
  ...
  Buddha: {
    ...
    node: (
      <g stroke={GOLD} strokeWidth="1.4">
        <circle cx="12" cy="12" r="8.2" fill={GOLD} fillOpacity="0.15" />
  ...
  Allah: {
    ...
    node: (
      <g>
        <path d="M16.4 4.2a8.2 8.2 0 1 0 3.2 12.8A8.2 8.2 0 0 1 16.4 4.2Z" fill={GREEN} fillOpacity="0.3" stroke={GREEN} strokeWidth="1.4" />
      </g>
    ),
  },
  ...
  Jehovah: {
    label: "Jehovah",
    node: (
      <g stroke={INDIGO} strokeWidth="1.4" fill={INDIGO} fillOpacity="0.14">
  ...
  Gayathri: {
    ...
    node: (
      <g>
        <path d="M4 14.2h16c0 3-3.4 5-8 5s-8-2-8-5Z" fill={BROWN} fillOpacity="0.25" stroke={BROWN} strokeWidth="1.4" />
  ...
  Vittala: {
    ...
    node: (
      <g stroke={GREEN} strokeWidth="1.3">
        <path d="M12 21c0-6 3-9.8 8-10.8-1 5.7-4 9.2-8 10.8Z" fill={GREEN} fillOpacity="0.25" />
        <path d="M12 21c0-6-3-9.8-8-10.8 1 5.7 4 9.2 8 10.8Z" fill={GREEN} fillOpacity="0.25" />
  ...
  Ayyappa: {
    ...
    node: (
      <g stroke={GOLD} strokeWidth="1.4">
        <path d="M6.4 16.2c0-5.2 1.9-8.4 5.6-8.4s5.6 3.2 5.6 8.4Z" fill={GOLD} fillOpacity="0.3" />
  ...
  "Sarva Dharma": {
    ...
    node: (
      <g>
        <circle cx="12" cy="12" r="8.4" fill={GOLD} fillOpacity="0.12" stroke={GOLD} strokeWidth="1.3" />
        ...
        <circle cx="12" cy="12" r="2.2" fill={GOLD} fillOpacity="0.5" stroke={GOLD} strokeWidth="1.1" />
      </g>
    ),
  },
};
